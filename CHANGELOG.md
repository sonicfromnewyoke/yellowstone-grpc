...
- yellowstone-grpc-client-13.0.0+triton-ext
- yellowstone-grpc-client-simple-13.0.0+triton-ext
- yellowstone-grpc-geyser-13.0.0+triton-ext
- yellowstone-grpc-proto-13.0.0+triton-ext

### Features
- proto: add `commission_bps` field to `Reward` message (SIMD-0291)
- geyser: upgrade agave monorepo dependencies to 4.0.0-beta.6
- geyser: upgrade Solana SDK dependencies to match agave 4.0.0-beta.6
...
- deps: update solana/agave git dependencies to v4.0.0-beta.6 (`v4.0.0-beta.6-triton-public`)
